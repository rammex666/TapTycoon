...
public class ItemBuilder {
    ...
    public static ItemStack getMaterialLoreItem(Material material, String customName, List<?> lore) {
        ItemStack it = new ItemStack(material);
        ItemMeta customM = it.getItemMeta();
        if (customName != null) customM.setDisplayName(customName);
        if (lore != null) customM.setLore(Collections.singletonList(lore.toString()));
        it.setItemMeta(customM);
        return it;
    }
}
